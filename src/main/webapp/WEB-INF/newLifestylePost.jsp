...
<body>
	...
	<div class="section body-main">
	   <div class="text-center">
		   <h1 class="lifestylepost-heading">Create a Lifestyle Post</h1>
		</div>
	   <form:form action="/lifestyleposts/new" method="POST" enctype="multipart/form-data" modelAttribute="newLifestylePost" class="form mt-3">
	   		<p>
	   		...
	   		<div class="d-flex justify-content-end">
		   		<a class="btn btn-secondary button-post" href="/dashboard/lifestyleposts">Cancel</a>
