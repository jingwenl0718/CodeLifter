...
<body>
	...
	<div class="section body-main">
	   <div class="text-center">
		   <h1 class="successstory-heading">Create a Success Story</h1>
		</div>
	   <form:form action="/successstories/new" method="POST" enctype="multipart/form-data" modelAttribute="newSuccessStory" class="form mt-3">
	   		<p>
