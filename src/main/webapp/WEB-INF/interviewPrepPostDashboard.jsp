...
<body>
	...
	<div class="section body-main">
		 <h1 class="text-center interviewpost-heading">All Interview-prep Posts</h1>
		<div class="text-end">
	 		<a class="btn newpost-button" href="/interviewposts/new">+ new post</a>
		</div>
			...
			<thead>
	   		...
	   		<tbody>
	   			<c:forEach var="eachInterviewPrepPost" items="${allInterviewPrepPostList}">
	   				<tr>
	   					<td class="table-body"><a href="/interviewposts/${eachInterviewPrepPost.id }"><c:out value="${eachInterviewPrepPost.title }"/></a></td>
	   					<td class="table-body"><c:out value="${eachInterviewPrepPost.headline }"/></td>
						<td class="table-body"><c:out value="${eachInterviewPrepPost.interviewPrepPostCreator. userName }"/></td>
	   				</tr>
	   			</c:forEach>
	   		</tbody>
	   </table>
