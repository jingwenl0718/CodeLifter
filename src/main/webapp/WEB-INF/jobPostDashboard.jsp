...
<body>
	...
	<div class="section body-main">
		<h1 class="text-center jobpost-heading">All Job-related Posts</h1>
		<div class="text-end">
	 		<a class="btn newpost-button" href="/jobposts/new">+ new post</a>
		</div>
	   		...
	   		<tbody>
	   			<c:forEach var="eachJobPost" items="${allJobPostList}">
	   				<tr>
						...
						<td class="table-body"><c:out value="${eachJobPost.jobPostCreator. userName }"/></td>
	   				</tr>
	   			</c:forEach>
	   		</tbody>
	   </table>
