...
<body>
	...
	<div class="section body-main">
	   <div class="text-center">
		   <h1 class="lifestylepost-heading">Edit a Lifestyle Post</h1>
		</div>
	   <form:form action="/lifestyleposts/${newLifestylePost.id }/edit" method="POST" modelAttribute="newLifestylePost" class="form mt-3">
